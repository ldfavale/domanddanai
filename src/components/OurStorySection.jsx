    ...
    <div id="our_story" className='flex flex-col pb-20'>
      <div className="">
        ...
        <div className='flex flex-col justify-center items-center  max-w-2xl md:mx-22'>
            ...
            We both left our lives in The Netherlands and Canada, in 2022, and started a new adventure in Uruguay. <br />
            It was in a small local church that we met and his family invited her over for lunch. We had so many things in common and it immediately felt like we’d been friends for years. It was the start of a good friendship.<br /><br />

            Throughout the summer, we became better friends and could talk for hours about combined interests.<br />
            Despite that, our love story began after summer.<br />
            Ironically, both of our families met each other before we fell in love. Little did we know… we would all become family very soon after that.<br /><br />

            We both knew we wanted to spend the rest of our lives together and the rest is history.            </p>
          </div>
        </div>
      </div>
