        ...
        <div className='border-[1.6px] border-solid border-[#edf3f5] p-[1.6px] flex col'>
          <div className='border-[1.6px] border-solid border-[#edf3f5]  w-full flex flex-col py-8 px-5 font-light'>
            <form action="" method="post">
              <input required name='name' type="text" placeholder='Your Name*' className='mb-6 h-11 w-full px-2 py-4 border-1 border-solid border-[#edf3f5] bg-[#fbfbfb]  text-sm '/>
              <input required  name='email' type="email" placeholder='Your Email*' className='mb-6 h-11 w-full px-2 py-4 border-1 border-solid border-[#edf3f5] bg-[#fbfbfb]  text-sm '/>
              <select name="guests" id="" className='mb-6 h-11 w-full px-2  border-1 border-solid border-[#edf3f5] bg-[#fbfbfb] text-sm text-gray-500 '>
              ...
              <select name="guests" id="" className='mb-6 h-11 w-full px-2  border-1 border-solid border-[#edf3f5] bg-[#fbfbfb] text-gray-500 text-sm '>
              ...
              <div className='flex justify-center'>
                <button  className='bg-[--main-color] py-4 px-6 uppercase text-white text-xs font-bold flex justify-center items-center' > Send Invitation <span className=' flex'>{arrow_right_icon}</span></button>
              </div>
            </form>
